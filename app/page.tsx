...
export default function Home() {
  return (
    <div style={{ minHeight: "100vh", background: "#0f0507", color: "#f0f0ff", fontFamily: "'Sora', sans-serif", overflowX: "hidden" }}>
      ...
      <style>{`
        ...
        .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 12px 40px rgba(220,30,50,0.5) !important; }
        .btn-secondary:hover { transform: translateY(-2px); background: rgba(255,255,255,0.08) !important; }
        .job-card:hover { transform: translateY(-4px); border-color: rgba(220,30,50,0.4) !important; }
        .stat-card:hover { transform: scale(1.03); }
        .feature-card:hover { border-color: rgba(220,30,50,0.35) !important; background: rgba(180,20,40,0.08) !important; }
        .country-pill:hover { background: rgba(180,20,40,0.22) !important; transform: translateY(-2px); }
      ...
      <div style={{ position: "fixed", inset: 0, pointerEvents: "none", zIndex: 0 }}>
        {/* Grid */}
        <div style={{ position: "absolute", inset: 0, backgroundImage: "linear-gradient(rgba(180,20,40,0.06) 1px, transparent 1px), linear-gradient(90deg, rgba(180,20,40,0.06) 1px, transparent 1px)", backgroundSize: "60px 60px" }} />
        {/* Glow blobs */}
        <div style={{ position: "absolute", top: "-10%", left: "50%", transform: "translateX(-50%)", width: 900, height: 600, background: "radial-gradient(ellipse, rgba(180,20,40,0.18) 0%, transparent 70%)", animation: "pulse-glow 5s ease-in-out infinite" }} />
        <div style={{ position: "absolute", top: "40%", left: "-10%", width: 500, height: 500, background: "radial-gradient(circle, rgba(16,185,129,0.06) 0%, transparent 70%)" }} />
      ...
      {/* ── NAV ── */}
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, padding: "16px 48px", display: "flex", alignItems: "center", justifyContent: "space-between", backdropFilter: "blur(20px)", background: "rgba(15,5,7,0.8)", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ width: 36, height: 36, borderRadius: 10, background: "linear-gradient(135deg, #e03050, #10b981)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18 }}>💼</div>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <Link href="/jobs" className="btn-primary" style={{ padding: "9px 22px", borderRadius: 10, border: "none", background: "linear-gradient(135deg, #e03050, #b01830)", color: "white", fontSize: 14, fontWeight: 600, textDecoration: "none", boxShadow: "0 4px 20px rgba(180,20,40,0.3)" }}>Get Started →</Link>
        </div>
      </nav>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <section style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "120px 24px 80px", textAlign: "center" }}>
          {/* Badge */}
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "7px 16px", borderRadius: 99, background: "rgba(180,20,40,0.12)", border: "1px solid rgba(180,20,40,0.28)", fontSize: 13, color: "#ff8099", marginBottom: 32, animation: "slide-up 0.6s ease forwards" }}>
          ...
          <h1 style={{ fontFamily: "'Cabinet Grotesk', sans-serif", fontSize: "clamp(52px, 8vw, 96px)", fontWeight: 900, letterSpacing: "-3px", lineHeight: 0.95, margin: "0 0 28px", maxWidth: 900, animation: "slide-up 0.7s ease forwards" }}>
            ...
            <span style={{ display: "block", background: "linear-gradient(135deg, #e03050 0%, #10b981 50%, #f59e0b 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Across The World</span>
          </h1>
          ...
          <div style={{ display: "flex", gap: 14, flexWrap: "wrap", justifyContent: "center", animation: "slide-up 0.9s ease forwards" }}>
            <Link href="/jobs" className="btn-primary" style={{ padding: "16px 40px", borderRadius: 14, textDecoration: "none", background: "linear-gradient(135deg, #e03050, #b01830)", color: "white", fontWeight: 700, fontSize: 17, boxShadow: "0 6px 30px rgba(220,30,50,0.4)", display: "inline-flex", alignItems: "center", gap: 8 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 16, marginTop: 72, maxWidth: 700, width: "100%" }}>
            {[
              { num: "970K+", label: "Total Jobs", icon: "📊", color: "#e03050" },
        ...
        {/* ── MARQUEE ── */}
        <div style={{ overflow: "hidden", padding: "20px 0", borderTop: "1px solid rgba(255,255,255,0.05)", borderBottom: "1px solid rgba(255,255,255,0.05)", background: "rgba(180,20,40,0.03)", marginBottom: 0 }}>
        ...
        <section style={{ padding: "100px 24px", maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            <div style={{ fontSize: 13, color: "#e03050", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 12 }}>Job Categories</div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: 12 }}>
            {[
              ...
              <Link href="/jobs" key={c.label} className="feature-card" style={{ padding: "20px 14px", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 14, textAlign: "center", textDecoration: "none", color: "inherit", display: "block", cursor: "pointer" }}>
                ...
                <div style={{ fontSize: 12, color: "#e03050" }}>{c.count} jobs</div>
              </Link>
            ))}
          </div>
        </section>
        ...
        {/* ── FEATURES ── */}
        <section style={{ padding: "100px 24px", background: "rgba(180,20,40,0.03)", borderTop: "1px solid rgba(255,255,255,0.05)", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: 20 }}>
              {[
                { icon: "🌍", title: "194 Countries", desc: "From the USA to Tuvalu — every country on earth has fresh job listings updated regularly.", color: "#e03050", rgb: "220,30,50" },
                ...
                { icon: "🤖", title: "Auto Publishing", desc: "Set it and forget it — auto mode publishes all 194 countries automatically with 10-min gaps.", color: "#ff8099", rgb: "167,143,255" },
              ].map(f => (
        ...
        <section style={{ padding: "100px 24px", maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: 16 }}>
            {[
              ...
              <Link href="/jobs" key={job.title} className="job-card" style={{ display: "block", textDecoration: "none", color: "inherit", padding: "22px", background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 16, cursor: "pointer" }}>
                ...
                <div style={{ fontSize: 15, fontWeight: 700, color: "#ff8099", marginBottom: 14 }}>{job.salary}/yr</div>
          ...
          <div style={{ textAlign: "center", marginTop: 40 }}>
            <Link href="/jobs" className="btn-primary" style={{ padding: "14px 40px", borderRadius: 12, textDecoration: "none", background: "linear-gradient(135deg, #e03050, #b01830)", color: "white", fontWeight: 700, fontSize: 16, boxShadow: "0 4px 24px rgba(180,20,40,0.3)", display: "inline-block" }}>
              View All Jobs →
            </Link>
          </div>
        </section>
        ...
        <section style={{ padding: "100px 24px", maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
            {[
              { step: "01", title: "Choose Your Country", desc: "Pick from 194 countries worldwide. Each country has localized jobs with local currencies and city names.", color: "#e03050" },
        ...
        <section style={{ padding: "80px 24px", maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ borderRadius: 24, padding: "64px 48px", textAlign: "center", background: "linear-gradient(135deg, rgba(180,20,40,0.18) 0%, rgba(16,185,129,0.1) 50%, rgba(245,158,11,0.08) 100%)", border: "1px solid rgba(180,20,40,0.28)", position: "relative", overflow: "hidden" }}>
            <div style={{ position: "absolute", top: "-50%", left: "50%", transform: "translateX(-50%)", width: 600, height: 400, background: "radial-gradient(ellipse, rgba(180,20,40,0.15) 0%, transparent 70%)", pointerEvents: "none" }} />
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
                <Link href="/jobs" className="btn-primary" style={{ padding: "16px 44px", borderRadius: 14, textDecoration: "none", background: "linear-gradient(135deg, #e03050, #b01830)", color: "white", fontWeight: 700, fontSize: 17, boxShadow: "0 6px 30px rgba(220,30,50,0.4)", display: "inline-block" }}>
                  Browse Jobs Now →
                </Link>
        ...
        <footer style={{ borderTop: "1px solid rgba(255,255,255,0.05)", padding: "40px 48px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{ width: 30, height: 30, borderRadius: 8, background: "linear-gradient(135deg, #e03050, #10b981)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 15 }}>💼</div>
